...
function rps(move) {
    ...
    //potential_choice_len = potential_choice.length; // For some reason, I need to put the value of this variable directly into random_move (fixes Autograder errors)
    const random_move = Math.floor(Math.random() * potential_choice.length); // Will be used as index for array of potential choices 
